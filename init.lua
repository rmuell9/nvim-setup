...
-- Control+Shift+z or Control+y to redo
...
require("lazy").setup({
...

	{
		...
		config = function()
			...
			-- Use <leader>r to run code
			vim.keymap.set("n", "<leader>p", ":RunCode<CR>", { noremap = true, silent = false })
		end,
	},
	{
	...
	},
	{
		...
		config = function()
			...
			end, { desc = "Create llm.md in new window" })
		end,
	},
	{
